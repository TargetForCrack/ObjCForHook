...
- (void)viewDidLoad {
    [super viewDidLoad];
    // 添加子控制器
    [self addOneViewController:[[BasicViewController alloc] init] image:@"tab_home_normal" selectedImage:@"tab_home_50" title:@"基本用法"];
    [self addOneViewController:[[ExpandViewController alloc] init] image:@"tab_team_normal" selectedImage:@"tab_team_50" title:@"扩展"];
    [self addOneViewController:[[ToolViewController alloc] init] image:@"tab_c2c_normal" selectedImage:@"tab_c2c_50" title:@"工具"];
    [self addOneViewController:[[OtherViewController alloc] init] image:@"tab_mine_normal" selectedImage:@"tab_mine_50" title:@"其他"];
